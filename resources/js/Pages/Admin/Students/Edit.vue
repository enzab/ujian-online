<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/students" class="btn btn-md btn-primary border-0 shadow mb-3" type="button">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="" id="" class="form-control" placeholder="Masukkan Nisn Siswa" v-model="form.nisn">
                                ...
                                <div class="col-md-6">
                                    <div class="md-4">
                                        ...
                                        <input type="text" name="" id="" class="form-control" placeholder="Masukkan Nama Siswa" v-model="form.name">
